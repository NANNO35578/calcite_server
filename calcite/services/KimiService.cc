...
std::string KimiService::buildRequestJson(const std::string& prompt) {
    Json::Value root;
...
TagRecommendationResult KimiService::parseResponse(const std::string& responseData) {
    TagRecommendationResult result;

    // std::cout<<"LLM response: "<<responseData<<'\n';
...
void KimiService::performLlmRequest(
...
void KimiService::recommendTags(
