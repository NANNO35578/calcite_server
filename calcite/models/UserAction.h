...
class UserAction
{
  public:
     ...
     */
    explicit UserAction(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UserAction(const Json::Value &pJson) noexcept(false);
     ...
     */
    UserAction(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    const int8_t &getValueOfActionType() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int8_t> &getActionType() const noexcept;
    ///Set the value of the column action_type
    void setActionType(const int8_t &pActionType) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<UserAction>;
    friend drogon::orm::BaseBuilder<UserAction, true, true>;
    friend drogon::orm::BaseBuilder<UserAction, true, false>;
    friend drogon::orm::BaseBuilder<UserAction, false, true>;
    friend drogon::orm::BaseBuilder<UserAction, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<UserAction>;
#endif
    ...
    std::shared_ptr<int8_t> actionType_;
