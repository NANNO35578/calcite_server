...
class Note
{
  public:
    ...
    void setFolderIdToNull() noexcept;
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<Note, true, true>;
    friend drogon::orm::BaseBuilder<Note, true, false>;
    friend drogon::orm::BaseBuilder<Note, false, true>;
    friend drogon::orm::BaseBuilder<Note, false, false>;
#ifdef __cpp_impl_coroutine
