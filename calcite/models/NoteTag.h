...
class NoteTag
{
  public:
    ...
    using PrimaryKeyType = std::tuple<int64_t,int64_t>;//note_id,tag_id
     ...
     */
    explicit NoteTag(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit NoteTag(const Json::Value &pJson) noexcept(false);
     ...
     */
    NoteTag(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<NoteTag>;
    friend drogon::orm::BaseBuilder<NoteTag, true, true>;
    friend drogon::orm::BaseBuilder<NoteTag, true, false>;
    friend drogon::orm::BaseBuilder<NoteTag, false, true>;
    friend drogon::orm::BaseBuilder<NoteTag, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<NoteTag>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where note_id = ? and tag_id = ?";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where note_id = ? and tag_id = ?";
        return sql;
    }
